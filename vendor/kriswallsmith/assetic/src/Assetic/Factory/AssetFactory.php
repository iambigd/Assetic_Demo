...
class AssetFactory
{
    ...
    public function createAsset($inputs = array(), $filters = array(), array $options = array())
    {
        ...
        // output --> target url
        //modified by ken 2013/7/30
        //$options['name'] asset filename
        $assetTargetPath = str_replace('*', $options['name'], $options['output']);
        // echo $assetTargetPath;
        $asset->setTargetPath($assetTargetPath);
